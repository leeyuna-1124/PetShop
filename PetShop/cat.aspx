<%@ Page Title="" Language="C#" MasterPageFile="~/PetShop.Master" AutoEventWireup="true" CodeBehind="cat.aspx.cs" Inherits="PetShop.cat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h3 class="auto-style5"><strong>고양이 용품</strong></h3>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:master %>" ProviderName="<%$ ConnectionStrings:master.ProviderName %>" SelectCommand="SELECT [pID], [pName], [category], [price] FROM [Cat]">
        </asp:SqlDataSource>
        <br />
        <hr />
        <div class="auto-style1">
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyNames="pID" DataSourceID="SqlDataSource2" GridLines="Horizontal" Height="50px" Width="1499px" >
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:masterConnectionString %>" SelectCommand="SELECT * FROM [Cat] WHERE ([pID] = @pID)">
                <SelectParameters>
